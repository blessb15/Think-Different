$(document).ready(function(){
  ...
  $('.nav-bar-img').click(function() {
    ...
    $('#page-1').removeClass('page-expand');
    $('#page-2').removeClass('page-expand');
    $('#page-3').removeClass('page-expand');
    $('#page-4').removeClass('page-expand');
    $('.base').removeClass('base-expand');
